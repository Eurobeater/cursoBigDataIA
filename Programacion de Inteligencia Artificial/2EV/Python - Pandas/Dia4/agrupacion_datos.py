...
data = {
    ...
    "Producto": ["Manzanas", "Plátanos", "Naranjas", "Peras", "Manzanas", "Plátanos", "Manzanas"],
    "Cantidad": [10, 5, 8, 12, 7, 6, 15],
    "Precio": [2,5, 1.8, 3.0, 2.2, 2.5, 1.8, 2.5]
}
...
estadisticas_producto = df.groupby("Producto")["Precio"].agg(["sum", "mean", "count"])
