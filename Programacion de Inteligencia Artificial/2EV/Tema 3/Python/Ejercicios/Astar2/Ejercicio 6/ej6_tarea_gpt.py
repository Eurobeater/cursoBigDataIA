...
from graph import Graph, Node, inf  # Asegúrate de importar "inf" si lo usas en reset_graph
...
print("\nBúsqueda c) Camino más corto entre A y H")
ruta("A", "H", grafo)
reset_graph(grafo)

print("\nBúsqueda d) Camino más corto entre G y C")
ruta("G", "C", grafo)
